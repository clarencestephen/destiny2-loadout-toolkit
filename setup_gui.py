...
class Wizard(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Destiny 2 Loadout Toolkit — Install")
        ...
        tk.Label(header, text="  DESTINY 2 LOADOUT TOOLKIT",
    ...
    def step_welcome(self):
        ...
        tk.Label(self.body,
                 text="This wizard will set up your personal Destiny 2 loadout workbook.\n"
